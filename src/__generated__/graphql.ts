...
export type FetchMeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, name: string, email: string, avatar?: { __typename?: 'File', url: string } | null, userGroups?: Array<{ __typename?: 'UserGroup', id: string, name: string, organization?: { __typename?: 'Organization', id: string, name: string, slug: string } | null, permissions: { __typename?: 'UserGroupPermission', Account: UserGroupRole, ApprovalAmount: number, BankAccount: UserGroupRole, BatchUpload: UserGroupRole, CreditCard: UserGroupRole, Customer: UserGroupRole, Report: UserGroupRole, Vendor: UserGroupRole } }> | null } };
