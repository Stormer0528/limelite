class Types::Report::ProfitAndLossByResourceReport < Types::Report::ReportBase
  ...
  field :resources, [String], null: true
  field :resource_titles, [String], null: true
  ...
  def url
    "/export/profit-and-loss-by-resource-report/#{object.id}"
  end
