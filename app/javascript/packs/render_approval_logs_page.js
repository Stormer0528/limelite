// Imports
//------------------------------------------------------------------------------
import ApprovalLogs from "../components/approval-logs";
...
const generateClassName = createGenerateClassName({
  productionPrefix: "approval-logs-index",
  seed: ["approval-logs", Math.random()].join("-"),
});
...
const renderComponent = (Component) => {
  const elem = document.getElementById("approval_logs_index");
  if (elem) {
...
document.addEventListener("DOMContentLoaded", () => {
  renderComponent(ApprovalLogs);
});

// Update from HMR Calls
if (module.hot) {
  module.hot.accept("../components/approval-logs", () => {
    renderComponent(ApprovalLogs);
  });
}
