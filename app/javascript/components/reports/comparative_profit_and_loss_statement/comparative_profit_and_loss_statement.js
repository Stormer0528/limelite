...
const ComparativeProfitAndLossStatement = ({
  reportPeriod,
  startDate,
  endDate,
  pdf_url: pdfPath,
  ...
  return (
    ...
    >
      ...
      <ReportTable
        {...data}
        {...{colspanWidth, accountFundCode, accountFundName, createLinkHandler}}
      />
      <ReportFooter />
    </section>
  );
...
ComparativeProfitAndLossStatement.propTypes = {
...
// Export
//------------------------------------------------------------------------------
export default withStyles(styles)(ComparativeProfitAndLossStatement);
