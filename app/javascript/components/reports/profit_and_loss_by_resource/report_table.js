      ...
      <Table className={classes.reportTable + " report-table condensed"}>
        <TableHead className={classes.header}>
          ...
          <TableRow className={classes.headerRow}>
            ...
            {titles.map((title) => (
              <TableCell key={title} style={{textAlign: "center"}}>
                <BalanceCell balance={capitalize(title)} />
              </TableCell>
            ))}
        ...
        <TableBody>
          ...
          <TableRow className={classes.titleTitleRow}>
            ...
            {titles.map((title, i) => (
              <TableCell key={`${title}-${i}`} style={{textAlign: "right"}}>
                <BalanceCell balance={revenues_range_totals[title]} />
              </TableCell>
            ))}
          ...
          <TableRow className={classes.titleTitleRow}>
            ...
            {titles.map((title, i) => (
              <TableCell key={`${title}-${i}`} style={{textAlign: "right"}}>
                <BalanceCell balance={expenses_range_totals[title]} />
              </TableCell>
            ))}
            <TableCell style={{textAlign: "right"}}>
          ...
          <TableRow className={classes.titleTitleTitleRow}>
            ...
            {titles.map((title, i) => (
              <TableCell key={`${title}-${i}`} style={{textAlign: "right"}}>
                <BalanceCell balance={excess_revenues_totals[title]} />
              </TableCell>
            ))}
            <TableCell style={{textAlign: "right"}}>
          ...
          <TableRow className={classes.titleTitleRow}>
            ...
            {titles.map((title, i) => (
              <TableCell key={`${title}-${i}`} style={{textAlign: "right"}}>
                <BalanceCell balance={other_financing_range_totals[title]} />
              </TableCell>
            ))}
            <TableCell style={{textAlign: "right"}}>
          ...
          <TableRow className={classes.titleTitleTitleRow}>
            ...
            {titles.map((title, i) => (
              <TableCell key={`${title}-${i}`} style={{textAlign: "right"}}>
                <BalanceCell balance={net_position_totals[title]} />
              </TableCell>
            ))}
            <TableCell style={{textAlign: "right"}}>
