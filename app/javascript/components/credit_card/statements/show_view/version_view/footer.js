  ...
  return (
    ...
    >
      ...
      >
        ...
        <Grid item>
          <h5>
            <small className={classes.balance}>{startingBalance}</small>
...
Footer.propTypes = {
  ...
  endingBalance: PropTypes.string,
  totalCredits: PropTypes.string,
  totalDebits: PropTypes.string,
  statementBalance: PropTypes.string,
