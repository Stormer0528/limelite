          ...
          <TableRow>
            <TableCell colSpan="4">
              <Typography
                ...
                component="h2"
              >
                <CreditCardIcon /> Credit Card Items
              </Typography>
            </TableCell>
          </TableRow>
          <TableRow>
...
export default CCItemsTable;

function CCItemIcon({type}) {
  switch (type) {
    case "Charge":
      return <ChargeIcon />;
    case "Payment":
