...
describe("CreditCard/Statements", () => {
  ...
  describe("#index", () => {
    const CC_SLUG = "test";
    const baseUrl = `/credit_cards/${CC_SLUG}/reconciliations`;
    ...
    it("can visit the page", () => {
      ...
      cy.location("pathname").should(
        "contains",
        `/credit_cards/${CC_SLUG}/reconciliations`
      );
    });
    ...
    describe("NavLinks", () => {
      ...
      it("Links to the CreditCard#show", () => {
        cy.get('[data-cy="cc-show-link"]')
          .invoke("attr", "href")
          .should("equal", `/credit_cards/${CC_SLUG}`);
      });
    });
