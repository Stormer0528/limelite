...
RSpec.describe BankAccount::AccountTransfer, type: :model do
  it "has a valid factory" do
    expect(build_stubbed(:account_transfer)).to be_valid
  end

  it { should belong_to(:bank_account) }
  it { should belong_to(:from_bank_account).class_name("BankAccount") }
end
