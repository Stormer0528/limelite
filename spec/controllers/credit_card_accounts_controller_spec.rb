...
RSpec.describe CreditCardsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      credit_card = CreditCard.create! valid_attributes
      get :show, params: {id: credit_card.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new CreditCard" do
        expect {
          post :create, params: {credit_card: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {credit_card: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested credit_card" do
        credit_card = CreditCard.create! valid_attributes
        put :update, params: {id: credit_card.to_param, credit_card: new_attributes}, session: valid_session
        credit_card.reload
      ...
      it "redirects to the credit_card" do
        credit_card = CreditCard.create! valid_attributes
        put :update, params: {id: credit_card.to_param, credit_card: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        credit_card = CreditCard.create! valid_attributes
        put :update, params: {id: credit_card.to_param, credit_card: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested credit_card" do
      credit_card = CreditCard.create! valid_attributes
      expect {
        delete :destroy, params: {id: credit_card.to_param}, session: valid_session
      }.to change(CreditCard, :count).by(-1)
    end
