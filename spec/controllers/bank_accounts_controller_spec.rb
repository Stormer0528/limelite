...
RSpec.describe BankAccountsController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      bank_account = BankAccount.create! valid_attributes
      get :edit, params: {id: bank_account.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new BankAccount" do
        expect {
          post :create, params: {bank_account: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {bank_account: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested bank_account" do
        bank_account = BankAccount.create! valid_attributes
        put :update, params: {id: bank_account.to_param, bank_account: new_attributes}, session: valid_session
        bank_account.reload
      ...
      it "redirects to the bank_account" do
        bank_account = BankAccount.create! valid_attributes
        put :update, params: {id: bank_account.to_param, bank_account: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        bank_account = BankAccount.create! valid_attributes
        put :update, params: {id: bank_account.to_param, bank_account: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
